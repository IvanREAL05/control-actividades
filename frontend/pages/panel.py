...
# 1. Obtener clases del día desde el backend (se usa en la pestaña "Hoy")
try:
...
tab_hoy, tab_escuela, tab_herramientas = st.tabs(["📋 Hoy", "🏫 Resumen Escuela", "🛠️ Herramientas"])

# =====================================================================
# PESTAÑA 1: HOY — clase seleccionada, asistencia, alumnos, asientos
# =====================================================================
with tab_hoy:
    ...
    # Accesos rápidos relacionados con "hoy"
    ...
    st.markdown(
        '<p class="seat-legend">🟢 Presente&nbsp;&nbsp;&nbsp;🔴 Ausente&nbsp;&nbsp;&nbsp;🟡 Justificante&nbsp;&nbsp;&nbsp;⚪ Sin registro</p>',
        unsafe_allow_html=True
    )
...
# =====================================================================
# PESTAÑA 2: RESUMEN ESCUELA — estadísticas agregadas de todo el plantel
# =====================================================================
with tab_escuela:
...
# =====================================================================
# PESTAÑA 3: HERRAMIENTAS — accesos a las páginas de generación/gestión
# =====================================================================
with tab_herramientas:
    st.markdown('<h2 class="section-title">🛠️ Herramientas</h2>', unsafe_allow_html=True)

    herramientas = [
        ("📲", "Generar QR", "Genera el QR de un alumno por matrícula", "pages/generarqr.py", "Generar QR"),
        ("📦", "QR Masivo", "Genera y descarga en un .zip los QR de todo un grupo", "pages/generarqr_masivo.py", "QR Masivo"),
        ("📊", "Reportes", "Descarga reportes de asistencias en Excel", "pages/reportes.py", "Ver reportes"),
    ...
    for fila_inicio in range(0, len(herramientas), 3):
        cols_h = st.columns(3)
        for col, (icono, titulo, descripcion, pagina, label) in zip(cols_h, herramientas[fila_inicio:fila_inicio + 3]):
            with col:
                st.markdown(f"""
                <div class="info-card">
                    <h4>{icono} {titulo}</h4>
                ...
                """, unsafe_allow_html=True)
                if st.button(label, key=f"tool_{pagina}"):
